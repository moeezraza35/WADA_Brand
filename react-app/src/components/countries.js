export default function Countries(){
	const countries = [
		...
		{name: "Cabo Verde", countryCode: "+238"},
		...
		{name: "Vatican City", countryCode: "+39"},
	...
	return (
		...
		{countries.map((row, index) => (
			<option key={index} value={row.countryCode}>{row.name} ({row.countryCode})</option>
		))}
		</>
	);
}